      ...
      body: BlocBuilder<EmployeeCubit, EmployeeState>(
        builder: (context, state) {
          ...
          for (var employee in state.employees) {
            if (employee.end.isEmpty || DateTime.parse(employee.end).isAfter(today)) {
          ...
          alignment: Alignment.centerLeft,  // Centers child vertically and horizontally
                ...
                ...List.generate(
                  currentEmployees.length,
                    ...
                    children: [
                      ...
                      if (index < currentEmployees.length - 1) Divider(), // Add divider except after the last item
                    ],
                  ),
                ),
              ],
                ...
                ...List.generate(
                  formerEmployees.length,
                    ...
                    children: [
                      ...
                      if (index < formerEmployees.length - 1) Divider(), // Add divider except after the last item
                    ],
                  ),
                ),
              ],
    ...
    return Slidable(
                    ...
                    onPressed: (BuildContext context) {
                       ...
                       Future.microtask(() {
                         ...
                         if(context.mounted) {
                           Navigator.push(
                           context,
                           MaterialPageRoute(builder: (context) => EmployeeDialog(employee: employee)),
                         );
                         }
                       });
      ...
      child:ListTile(
              ...
              subtitle: Column(
                ...
                children: [
                  Text(employee.role,style: TextStyle(
                    fontWeight: FontWeight.normal,
                      fontSize: 12,
                      color: AppColors.grey2
                  )),
                  Text('From ${employee.start}',style: TextStyle(
                    fontWeight: FontWeight.normal,
                      fontSize: 12,
                    color: AppColors.grey2
                  )),
